  ...
  <tr>
    <td>
      <h5 itemprop="headline">
        <a href="#" title="" itemprop="url">
          {props.admins.username}
        </a>
      </h5>
    </td>
    
    <td> {props.admins.emailId}</td>
    <td>
      {props.admins.role}
      </td>
    <td>
    ...
    <a
          ...
          href={"EditUser/" + props.admins._id}
          title=""
          itemprop="url"
      ...
      <a
          className="brd-rd3  red-bg"
          href={"ViewUser/"+ props.admins._id}
          title=""
          itemprop="url"
      ...
      <a
         ...
         title=""
          itemprop="url"
        ><button type="button" class="btn btn-danger" onClick={(e) => { props.deleteAdmin(props.admins._id)}}> Delete</button>
      </a>
...
const Moderators= props=>(
  ...
  <tr>
    <td>
      <h5 itemprop="headline">
        <a href="#" title="" itemprop="url">
          {props.moderators.username}
        </a>
      </h5>
    </td>
    
    
    <td> {props.moderators.emailId}</td>
    <td>{props.moderators.role}</td>
    <td>

    <a
          className="brd-rd3  red-bg"
          href={"EditUser/" + props.moderators._id}
          title=""
          itemprop="url"
        ><button type="button" class="btn btn-success"><i className="fa fa- "></i> Edit</button>
      </a>
      ...
      <a
          className="brd-rd3  red-bg"
          href={"ViewUser/"+ props.moderators._id}
          title=""
          itemprop="url"
        ><button type="button" class="btn btn-info"><i className="fa fa- "></i> View</button>
      </a>
      ...
      <a
         ...
         title=""
          itemprop="url"
        ><button type="button" class="btn btn-danger" onClick={(e) => { props.deleteAdmin(props.moderators._id)}}> Delete</button>
      </a>
...
class TabTwo extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = { admins:[], moderators:[], users:[], restaurants:[],events: [], reviews:[], loggedUser:[]};
...
//Admins
        ...
        .then(response => {
            ...
            const adminsFiltered = response.data
            .map(user=>user)
            .filter(user =>
               user.role=="admin")
            const admins = adminsFiltered


            this.setState({ admins })


            const moderatorsFiltered = response.data
            .map(user=>user)
            .filter(user =>
               user.role=="moderator")
            const moderators = moderatorsFiltered
            ...
            .map(user=>user)
            .filter(user =>
               user.role=="user"||user.role=="admin"||user.role=="moderator"||user.role=="deactive")
...
adminList() {
  return this.state.admins.map(admin => {
      return <Admins className="card-deck card" admins={admin}  key={admin._id} deleteAdmin={this.deleteAdmin} />;
  })
}
moderatorList() {
  return this.state.moderators.map(moderator => {
      return <Moderators className="card-deck card" moderators={moderator}  key={moderator._id} deleteAdmin={this.deleteAdmin} />;
  })
}
userList() {
                  ...
                  >
                    <div className="profile-sidebar-inner brd-rd5">
                      ...
                      >
                        ...
                        >
                          <a href="#users">
                            <i className="fa fa-file-text"></i>  Admins
                          </a>
                        </Tab>
                        ...
                        >
                          <a href="#users">
                            <i className="fa fa-file-text"></i>  Moderators
                          </a>
                        </Tab>
              ...
              <div className="col-md-8">
                <TabPanel>
                  ...
                  >
                    <div className="dashboard-wrapper brd-rd5">
                      ...
                      <a
                        className="brd-rd3 "
                          href="/CreateUser/admin"
                        title=""
                         itemprop="url"
                      ><button type="button" class="btn btn-success"><i className="fa fa-plus "></i> Create Admin</button>
                    </a>
                    
                    <br /><br /><br />
                    <a
                        className="brd-rd3 "
                          href="/CreateUser/moderator"
                        title=""
                         itemprop="url"
                      ><button type="button" class="btn btn-success"><i className="fa fa-plus "></i> Create Moderator</button>
                    </a>
                ...
                <TabPanel id="admins">
                  ...
                  >
                    ...
                    <br />
                    <br />
                    <h4 itemprop="headline">Admin List</h4>
                ...
                <TabPanel id="moderators">
                  ...
                  >
                    ...
                    <br />
                    <br />
                    <h4 itemprop="headline">Moderator List</h4>
                      <div className="booking-table table-hover">
                        <table>
                          <thead>
                            <tr>
